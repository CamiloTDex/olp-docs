...
* **Method:** Enum, can be one of the following options
  * [ltl\_quote.md](../integration-guides/network-interfaces/webhooks/ltl\_quote.md "mention")
  * [accept\_ltl\_quote.md](../integration-guides/network-interfaces/webhooks/accept\_ltl\_quote.md "mention")
